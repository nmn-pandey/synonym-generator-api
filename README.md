...
|--------------------|-----------|--------------------------------------------------|
| `word`             | String    | Echo of the input word for verification         |
| `synonyms`         | Array     | Unranked list of 10 synonyms generated by the LLM             |
| `ranked_synonyms`  | Array     | Ordered list of 10 synonyms by relevance, most relevant first |
